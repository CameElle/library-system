...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main class="frame" onload="initClock()">
            ...
            <div class="idnum">ID NUMBER: </div>
                ...
                <tr>
                    <td><asp:Button ID="L_In" runat="server" Text="Login" BackColor="#E98833" /> </td>
                    <td> <asp:Button ID="L_Out" runat="server" Text="Logout" BackColor="#E98833" /></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <div class="datetime">
                ...
                <tr>
                    <td colspan="2"> <button style="background: white; font-weight: bolder;" href="Register.aspx" class="auto-style5">Register</button> </td>
                </tr>
    </table>
